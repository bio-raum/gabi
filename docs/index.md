...
- requires only Nextflow and a container/environment manager to run
- easy deployment on a variety of configuartions through containerization

## Citation

There is no publication for GABI yet -  stay tuned! In the meantime, you can cite this repository should
you use GABI in your research.
