...
This pipeline requires Nextflow versions between [24.10.5](https://github.com/nextflow-io/nextflow/releases/tag/v24.10.5) and [26.04.3](https://github.com/nextflow-io/nextflow/releases/tag/v26.04.3).
...
- use additional container/package managers not pre-configured in GABI, as described [here](https://www.nextflow.io/docs/latest/container.html).
...
This pipeline requires locally stored references:
